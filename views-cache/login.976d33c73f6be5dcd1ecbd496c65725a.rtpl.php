  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="/res/admin//index2.html"><b>Página</b>Administrativa</a>
      </div>
      <!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Acesso Administrador</p>
        ...
        <a href="/index.php/admin/forgot">Esqueci a senha</a><br />
